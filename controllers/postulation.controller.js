...
module.exports.createPostulation = (request, response) =>{
    const {idUsuario, idEmpleo, estado, motivoRechazo, estadoPostulacion, fechaPostulacion} = request.body;
    console.log(request.body)
    Postulation.create({
        idUsuario, idEmpleo, estado, motivoRechazo, estadoPostulacion, fechaPostulacion
    })
